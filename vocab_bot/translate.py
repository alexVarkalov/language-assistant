...
async def translate_text(
    *,
    ...
    return await _mymemory(trimmed, source_lang, target_lang, client)
...
async def _mymemory(text: str, source_lang: str, target_lang: str, client: httpx.AsyncClient) -> str:
